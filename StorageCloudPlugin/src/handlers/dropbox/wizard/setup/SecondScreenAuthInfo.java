...
public class SecondScreenAuthInfo extends TitleAreaDialog {
	...
	public SecondScreenAuthInfo(Shell parentShell, HashMap<String, String> temp) {
		super(parentShell);
		info = temp;
	}
	...
	public void create() {
		super.create();
		setTitle("Is this yours Dropbox Account?");
	...
	protected void createButtonsForButtonBar(Composite parent) {
		Button button = createButton(parent, IDialogConstants.OK_ID, "Yes", true);
		...
		Button button_1 = createButton(parent, IDialogConstants.CANCEL_ID, "No", false);
