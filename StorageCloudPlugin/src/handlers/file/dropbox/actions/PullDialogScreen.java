...
public class PullDialogScreen extends TitleAreaDialog {
	private ArrayList<String> SelectName;
	Button cb[];
	boolean[] select;
	private boolean complete = false;

	public PullDialogScreen(Shell parentShell, ArrayList<String> temp1) {
		super(parentShell);
		SelectName = temp1;
	...
	public void create() {
		super.create();
		setTitle("Pull Information");
		setMessage("Pull files from Dropbox", IMessageProvider.INFORMATION);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblNewLabel.setText("Select the files that you want to pull from dropbox:");
	...
	protected void createButtonsForButtonBar(Composite parent) {
		Button button = createButton(parent, IDialogConstants.OK_ID, "Pull", true);
